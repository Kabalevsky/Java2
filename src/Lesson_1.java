...
public class Lesson_1 {
    public static void main(String[] args) {
        ...
        // Генерируем значения для числовых величин
        int distanceMin = 1;
        int distanceMax = 6;
        int heightMin = 1;
        int heightMax = 4;
        ...
        // Задаем параметры высоты стены и длины беговой дорожки
        ...
        // Задаем параметры высоты прыжка и длины бега
        for (int i = 0; i < 1; i++) {
